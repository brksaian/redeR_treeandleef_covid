...
ds = union_ds[, c("Deaths_cumulative_total_per_100000_population", "PERSONS_VACCINATED_1PLUS_DOSE_PER100")]
...
tal <- att.setv(g = tal, from = "Deaths_per_100k", to = "nodeSize", xlim=c(50, 100, 5), nquant = 7)
...
#--- Add legends
addLegend.color(rdp, tal, title="Vaccinated_per_100k")
addLegend.size(rdp, tal, title="Deaths_per_100k", position="bottomright")
